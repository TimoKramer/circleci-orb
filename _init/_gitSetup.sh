...
_gitSetup() {
    ...
    sleep 1
    echo
    git push -f -u origin master || { echo "You do not appear to have access to this repository. Please ensure you have write permissions to this repo to push code."; exit 1; }
    sleep 1
}
